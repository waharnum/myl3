    ...
    fluid.defaults("floe.dashboard.journal", {
        ...
        listeners: {
            "onCreate.createJournalMarkup": {
                this: "{that}.container",
                method: "append",
                args: "{that}.options.resources.stringTemplate",
                priority: "first"
            },
